...
<li class="nav-item menu-items">
<a class="nav-link" data-bs-toggle="collapse" href="#user-ui" aria-expanded="false" aria-controls="ui-basic">
  <span class="menu-icon">
...
<div class="collapse" id="role-ui">
  <ul class="nav flex-column sub-menu">
    <li class="nav-item {{ Request::is('role') ? 'active' : '' }} "> <a class="nav-link">View Roles</a></li>
    <li class="nav-item {{ Request::is('role/create') ? 'active' : '' }}"> <a class="nav-link">Add Role</a></li>
  </ul>
</div>
</li>
...
<div class="collapse" id="catagory-ui">
  <ul class="nav flex-column sub-menu">
    <li class="nav-item {{ Request::is('catagory') ? 'active' : '' }}"> <a class="nav-link" href="{{route('catagory-index')}}">View Catagories</a></li>
    <li class="nav-item {{ Request::is('catagory/create') ? 'active' : '' }}"> <a class="nav-link" href="{{route('catagory-create')}}">Add Catagory</a></li>
  </ul>
</div>
</li>

<li class="nav-item menu-items">
<a class="nav-link" data-bs-toggle="collapse" href="#product-ui" aria-expanded="false" aria-controls="ui-basic">
  <span class="menu-icon">
    <i class="mdi mdi-note-plus"></i>
  </span>
...
<div class="collapse" id="product-ui">
  <ul class="nav flex-column sub-menu">
    <li class="nav-item {{ Request::is('product') ? 'active' : '' }}"> <a class="nav-link" href="{{route('product-index')}}">View Products</a></li>
    <li class="nav-item {{ Request::is('product/create') ? 'active' : '' }}"> <a class="nav-link" href="{{route('product-create')}}">Add Product</a></li>
  </ul>
</div>
</li>
